...
def test_create_user_0_letter_in_first_name_get_success_response():
    positive_assert("Aa")
...
# Prueba 5. Error
# El parámetro "firstname" contiene palabras con espacio
...
# Prueba 7. Error
# El parámetro "firstname" contiene un string de numeros
